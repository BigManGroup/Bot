...
function main(message: Message, formattedMessage: FormattedMessage, middleware: CentralizedMiddleware): void {
    ...
    middleware.guildMiddleware.setQuoteSubmissionChannel(channel).then(() => message.reply({content: "Quote submission channel updated"})).catch(error => console.log(error));
}
