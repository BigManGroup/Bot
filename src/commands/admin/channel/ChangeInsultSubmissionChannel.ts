...
function main(message: Message, formattedMessage: FormattedMessage, middleware: CentralizedMiddleware): void {
    ...
    middleware.guildMiddleware.setInsultSubmissionChannel(channel).then(() => message.reply({content: "Insult submission channel updated"})).catch(error => console.log(error));
}
